    ...
    <section id="features" className="py-24 sm:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
           <h2 className="text-4xl sm:text-5xl font-extrabold font-heading text-slate-900 dark:text-white">Why Choose QUANZAB?</h2>
           <p className="mt-4 max-w-3xl mx-auto text-lg text-slate-600 dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center">
              ...
              <h3 className="text-2xl font-bold font-heading text-slate-900 dark:text-white">{feature.title}</h3>
              <p className="text-slate-600 dark:text-gray-400 mt-2">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
