        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1 mb-8 md:mb-0">
             <a href="#" className="flex items-center space-x-3">
                ...
                <span className="text-2xl font-bold font-heading bg-gradient-to-r from-slate-700 to-slate-500 dark:from-slate-200 dark:to-slate-400 text-transparent bg-clip-text">QUANZAB Toolkit</span>
            </a>
            ...
            <div key={section.title}>
              ...
              <ul className="space-y-3">
                {section.links.map(link => (
                  <li key={link}>
                    <a href="#" className="text-slate-700 dark:text-gray-300 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 text-base">{link}</a>
                  </li>
                ))}
              </ul>
            </div>
