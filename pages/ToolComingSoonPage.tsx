  ...
  return (
    <ToolPageLayout title={tool.name} description={tool.description}>
      <div className="text-center py-10">
        <h2 className="text-3xl font-bold mb-4 text-brand-dark dark:text-white">Coming Soon!</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
          We're working hard to bring you this tool. It will be available in a future update. Stay tuned!
        </p>
        <Link
          to="/"
          className="inline-block px-8 py-3 text-lg font-semibold text-white bg-brand-primary rounded-lg shadow-lg hover:bg-blue-800 transition-all duration-300 transform hover:scale-105"
        >
          Back to All Tools
        </Link>
      </div>
