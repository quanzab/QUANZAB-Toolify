        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <textarea value={from} onChange={e => setFrom(e.target.value)} rows={4} className="w-full p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none"></textarea>
                </div>
                <div>
                    <label className="block font-semibold mb-1 text-slate-800 dark:text-gray-200">To</label>
                    <textarea value={to} onChange={e => setTo(e.target.value)} rows={4} className="w-full p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none"></textarea>
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label className="block font-semibold mb-1 text-slate-800 dark:text-gray-200">Invoice Number</label>
                    <input type="text" value={invoiceNumber} onChange={e => setInvoiceNumber(e.target.value)} className="w-full p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none" />
                </div>
                <div>
                    <label className="block font-semibold mb-1 text-slate-800 dark:text-gray-200">Date</label>
                    <input type="date" value={date} onChange={e => setDate(e.target.value)} className="w-full p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none" />
                </div>
            </div>
            ...
            {items.map((item, index) => (
                <div key={index} className="flex items-center gap-2">
                    <input type="text" placeholder="Description" value={item.description} onChange={e => handleItemChange(index, 'description', e.target.value)} className="w-1/2 p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none" />
                    <input type="number" placeholder="Quantity" value={item.quantity} onChange={e => handleItemChange(index, 'quantity', parseFloat(e.target.value))} className="w-1/6 p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none" />
                    <input type="number" placeholder="Price" value={item.price} onChange={e => handleItemChange(index, 'price', parseFloat(e.target.value))} className="w-1/6 p-2 border rounded-md bg-slate-100 dark:bg-slate-800 border-transparent dark:border-slate-600 focus:ring-2 focus:ring-primary shadow-sm dark:shadow-none" />
