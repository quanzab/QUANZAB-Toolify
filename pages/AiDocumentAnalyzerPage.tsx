    ...
    >
      {!file ? (
        ...
        <div className="flex flex-col h-[70vh]">
          <div className="flex justify-between items-center p-2 bg-slate-800 rounded-t-lg border-b border-slate-700">
          ...
          <div className="flex-grow p-4 overflow-y-auto bg-slate-900">
            ...
            {isLoading && (
              <div className="flex justify-start mb-4">
                  <div className="max-w-prose p-3 rounded-lg bg-slate-700">
          ...
          <div className="p-4 bg-slate-800 rounded-b-lg border-t border-slate-700">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-grow p-2 border rounded-md bg-slate-700 border-slate-600"
              />
